...
class Fusion(nn.Module):
    def __init__(self, args, ehr_model, cxr_model):
        ...
        if self.args.labels_set == 'radiology' and (self.args.fusion_type == 'early' or self.args.fusion_type == 'joint' or self.args.fusion_type == 'late' ):
            target_classes = self.args.vision_num_classes
            lstm_in = self.ehr_model.feats_dim
            projection_in = self.cxr_model.feats_dim
        elif self.args.labels_set == 'radiology':
            target_classes = self.args.vision_num_classes
